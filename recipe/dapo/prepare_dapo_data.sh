...
export VERL_HOME=${VERL_HOME:-"./data"}
export TRAIN_FILE=${TRAIN_FILE:-"${VERL_HOME}/dapo17k/dapo-math-17k.parquet"}
export TEST_FILE=${TEST_FILE:-"${VERL_HOME}/dapo17k/aime-2024.parquet"}
