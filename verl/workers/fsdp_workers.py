...
class ActorRolloutRefWorker(Worker):
    ...
    def compute_log_prob(self, data: DataProto):
        ...
        with self.ulysses_sharding_manager:
            ...
            output, entropys, self_certaintys, actual_token_logits = self.actor.compute_log_prob(data=data, calculate_entropy=True, calculate_self_certainty=True)
            output = DataProto.from_dict(
                tensors={"old_log_probs": output, "entropys": entropys, "self_certaintys": self_certaintys, "actual_token_logits": actual_token_logits},
    ...
    def compute_ref_log_prob(self, data: DataProto):
        ...
        with self.ulysses_sharding_manager:
            data = self.ulysses_sharding_manager.preprocess_data(data)
            output, _, _, _ = self.ref_policy.compute_log_prob(data=data, calculate_entropy=False, calculate_self_certainty=False)
