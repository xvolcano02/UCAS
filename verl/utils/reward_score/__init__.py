...
def _default_compute_score(data_source, solution_str, ground_truth, extra_info=None, sandbox_fusion_url=None, concurrent_semaphore=None):
    ...
    elif data_source == "musique":
        from . import qa

        res = qa.compute_score(solution_str, ground_truth)
    ...
    elif data_source == "math_dapo" or data_source.startswith("aime") or data_source == "hiyouga/math12k":
