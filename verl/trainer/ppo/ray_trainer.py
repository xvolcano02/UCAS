...
def compute_advantage(data: DataProto, adv_estimator, gamma=1.0, lam=1.0, num_repeat=1, multi_turn=False, norm_adv_by_std_in_grpo=True):
    ...
    if adv_estimator == AdvantageEstimator.GAE:
        ...
        token_level_certaintys = data.batch["self_certaintys"]          # shape: [B, T]
        token_level_logits = data.batch["actual_token_logits"]          # shape: [B, T]
        response_mask = data.batch["response_mask"].to(token_level_certaintys.dtype)

        advantages, returns = core_algos.compute_ucas_advantage(
            token_level_rewards=data.batch["token_level_rewards"],
            token_level_certaintys=token_level_certaintys,
            ...
            for batch_dict in self.train_dataloader:
                ...
                with _timer("step", timing_raw):
                    ...
                    with _timer("old_log_prob", timing_raw):
                        ...
                        actual_token_logits = old_log_prob.batch["actual_token_logits"]
